...
from flask import Flask, abort, render_template, redirect, url_for, flash, g, request, make_response
...
def show_post(post_id):
    ...
    comments = db.session.execute(db.select(Comment).where(BlogPost.id == post_id)).scalars().all()
